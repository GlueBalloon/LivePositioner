...
function recreateScene()
    ...
    local newEntity = scene:entity()
    newEntity.position = vec3(0.000000, 108.225105, 0.000000)
    newEntity.rotation = quat.eulerAngles(0.000000, 0.000000, 0.000000)
    newEntity.scale = vec3(1.000000, 1.000000, 1.000000)
    newEntity.sliderEulers = vec3(0.000000, 0.000000, 0.000000)
    newEntity.modelPack = "Blocky_Characters"
    ...
    local newEntity = scene:entity()
    newEntity.position = vec3(38.225109, 8.961035, -14.088747)
    newEntity.rotation = quat.eulerAngles(-180.129868, 210.519485, 52.337658)
    newEntity.scale = vec3(1.000000, 1.000000, 1.000000)
    newEntity.sliderEulers = vec3(-180.129868, 210.519485, 52.337658)
    newEntity.modelPack = "Blocky_Characters"
