...
function recreateScene()
    ...
    local newEntity = scene:entity()
    newEntity.position = vec3(-122.857170, 38.701302, -215.065063)
    newEntity.rotation = quat.eulerAngles(-0.865801, 173.333344, 57.575756)
    newEntity.scale = vec3(3.093074, 3.093074, 1.486282)
    newEntity.sliderEulers = vec3(-0.865801, 173.333344, 57.575756)
    newEntity.modelPack = "SpaceKit"
    newEntity.modelName = "pipeStandStraightLiner.obj"
    ...
    local newEntity = scene:entity()
    newEntity.position = vec3(-70.303032, 23.896103, -233.160172)
    newEntity.rotation = quat.eulerAngles(-3.896087, -47.186134, -25.974030)
    newEntity.scale = vec3(3.090912, 3.090909, 2.961038)
    newEntity.sliderEulers = vec3(-3.896087, -47.186134, -25.974030)
    newEntity.modelPack = "SpaceKit"
    ...
    local newEntity = scene:entity()
    newEntity.position = vec3(-49.956711, -5.887447, -256.796539)
    newEntity.rotation = quat.eulerAngles(-51.515137, -46.753242, -43.722942)
    newEntity.scale = vec3(3.090909, 3.090909, 4.389610)
    newEntity.sliderEulers = vec3(-51.515137, -46.753242, -43.722942)
    newEntity.modelPack = "SpaceKit"
    newEntity.modelName = "pipeStraight.obj"
