...
function recreateScene()
    ...
    local newEntity = scene:entity()
    newEntity.position = vec3(-110.995674, 23.852814, -134.199127)
    newEntity.rotation = quat.eulerAngles(0.000000, -157.792206, 0.000000)
    newEntity.scale = vec3(2.000000, 2.000000, 2.000000)
    newEntity.sliderEulers = vec3(0.000000, -157.792206, 0.000000)
    newEntity.modelPack = "CastleKit"
    ...
    local newEntity = scene:entity()
    newEntity.position = vec3(-121.212120, -27.229456, -125.541122)
    newEntity.rotation = quat.eulerAngles(0.000000, 0.000000, 0.000000)
