...
function recreateScene()
    ...
    local newEntity = scene:entity()
    newEntity.position = vec3(78.422089, -3.829004, -175.647125)
    newEntity.rotation = quat.eulerAngles(-12.467532, 157.402603, -17.922077)
    newEntity.scale = vec3(2.874009, 2.874009, 2.874009)
    newEntity.sliderEulers = vec3(-12.467532, 157.402603, -17.922077)
    newEntity.modelPack = "SpaceKit"
