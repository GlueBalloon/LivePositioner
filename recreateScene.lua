...
function recreateScene()
    ...
    local newEntity = scene:entity()
    newEntity.position = vec3(-80.346321, 16.536797, -244.242416)
    newEntity.rotation = quat.eulerAngles(-30.303030, -3.030303, 0.000000)
    newEntity.scale = vec3(3.090909, 3.090909, 2.441558)
    newEntity.sliderEulers = vec3(-30.303030, -3.030303, 0.000000)
    newEntity.modelPack = "SpaceKit"
