...
function recreateScene()
    ...
    newEntity.eulerAngles = vec3(0.000000, 0.000000, -12.467532)
    newEntity.scale = vec3(1.000000, 1.000000, 1.000000)
    newEntity.sliderEulers = vec3(0.000000, 0.000000, -12.467532)
    newEntity.modelPack = "Blocky_Characters"
    ...
    newEntity.eulerAngles = vec3(0.000000, 2.337662, 0.000000)
    newEntity.scale = vec3(1.000000, 1.000000, 1.000000)
    newEntity.sliderEulers = vec3(0.000000, 2.337662, 0.000000)
    newEntity.modelPack = "Blocky_Characters"
    ...
    newEntity.eulerAngles = vec3(0.000000, 28.051950, 0.000000)
    newEntity.scale = vec3(2.121212, 2.121212, 2.121212)
    newEntity.sliderEulers = vec3(0.000000, 28.051949, 0.000000)
    ...
    local newEntity = scene:entity()
    newEntity.position = vec3(-203.463211, -47.619049, 160.173157)
    newEntity.eulerAngles = vec3(0.000000, -0.000000, 0.000000)
    newEntity.scale = vec3(151.000000, 98.402596, 151.000000)
    newEntity.sliderEulers = vec3(0.000000, 0.000000, 0.000000)
    ...
    newEntity.eulerAngles = vec3(0.000000, -3.896104, 0.000000)
    newEntity.scale = vec3(65.367966, 52.294373, 52.294373)
    newEntity.sliderEulers = vec3(0.000000, -3.896104, 0.000000)
    newEntity.modelPack = "Nature"
    ...
    newEntity.eulerAngles = vec3(0.000000, -0.000000, 6.233765)
    newEntity.scale = vec3(58.831169, 39.220779, 91.515152)
    newEntity.sliderEulers = vec3(0.000000, 0.000000, 6.233766)
    newEntity.modelPack = "Nature"
    ...
    local newEntity = scene:entity()
    newEntity.position = vec3(4.329004, -34.632034, 0.000000)
    newEntity.eulerAngles = vec3(2.088948, -10.709599, -11.104914)
    newEntity.scale = vec3(14.480471, 14.480471, 14.480471)
    newEntity.sliderEulers = vec3(0.000000, -10.909091, -10.909091)
    ...
    newEntity.eulerAngles = vec3(0.000000, 0.000000, -19.480520)
    newEntity.scale = vec3(2.337662, 2.337662, 2.337662)
    newEntity.sliderEulers = vec3(0.000000, 0.000000, -19.480520)
    ...
    newEntity.eulerAngles = vec3(0.000000, -0.000000, 9.350649)
    newEntity.scale = vec3(84.978348, 84.978348, 65.367966)
    newEntity.sliderEulers = vec3(0.000000, 0.000000, 9.350649)
    newEntity.modelPack = "Nature"
    newEntity.modelName = "naturePack_119.obj"
    ...
    newEntity.eulerAngles = vec3(0.000000, -0.000000, 0.779221)
    newEntity.scale = vec3(3.116883, 3.116883, 3.116883)
    newEntity.sliderEulers = vec3(0.000000, 0.000000, 0.779221)
    newEntity.modelPack = "SpaceKit"
    ...
    newEntity.eulerAngles = vec3(0.000000, 0.000000, -1.558442)
    newEntity.scale = vec3(4.414460, 8.828920, 4.966268)
    newEntity.sliderEulers = vec3(0.000000, 0.000000, -1.558442)
    newEntity.modelPack = "CastleKit"
