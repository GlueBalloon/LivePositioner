function easyCraftRecreate()
    ...
    local newEntity = EasyCraft.makeAThing("196793", "CastleKit", "wallPillar.obj", vec3(-67.965332, -20.885281, -340.000000), vec3(180.000000, 0.000005, 180.000000), vec3(4.000000, 4.000000, 4.000000), vec3(0.000000, -180.000000, 0.000000))
    sceneTable.entities[newEntity.name] = newEntity
