function easyCraftRecreate()
    ...
    local newEntity = EasyCraft.makeAThing("121518472", "SpaceKit", "pipeStandStraightLiner.obj", vec3(-122.857170, 38.701302, -215.065063), vec3(173.905319, 2.841805, 122.323349), vec3(3.093074, 3.093074, 1.486282), vec3(-0.865801, 173.333344, 57.575756))
    sceneTable.entities[newEntity.name] = newEntity
    ...
    local newEntity = EasyCraft.makeAThing("54461305", "SpaceKit", "pipeStraight.obj", vec3(-70.303032, 23.896103, -233.160172), vec3(22.420938, -42.819759, -36.563358), vec3(3.090912, 3.090909, 2.961038), vec3(-3.896087, -47.186134, -25.974030))
    sceneTable.entities[newEntity.name] = newEntity
    ...
    local newEntity = EasyCraft.makeAThing("1451641736", "SpaceKit", "pipeStraight.obj", vec3(-49.956711, -5.887447, -256.796539), vec3(15.203525, -63.779099, -76.778610), vec3(3.090909, 3.090909, 4.389610), vec3(-51.515137, -46.753242, -43.722942))
    sceneTable.entities[newEntity.name] = newEntity
