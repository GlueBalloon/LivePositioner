function easyCraftRecreate()
    ...
    local newEntity = EasyCraft.makeAThing("1756907330", "Blocky_Characters", "Adventurer.obj", vec3(0.000000, 108.225105, 0.000000), vec3(0.000000, -0.000000, 0.000000), vec3(1.000000, 1.000000, 1.000000), vec3(0.000000, 0.000000, 0.000000))
    sceneTable.entities[newEntity.name] = newEntity
    ...
    local newEntity = EasyCraft.makeAThing("54253005", "Blocky_Characters", "Orc.obj", vec3(38.225109, 8.961035, -14.088747), vec3(-25.082026, -17.983484, -123.665916), vec3(1.000000, 1.000000, 1.000000), vec3(-180.129868, 210.519485, 52.337658))
    sceneTable.entities[newEntity.name] = newEntity
