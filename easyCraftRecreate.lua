function easyCraftRecreate()
    ...
    local newEntity = EasyCraft.makeAThing("1863112216", "SpaceKit", "buildingOpen.obj", vec3(-90.909088, 90.909088, -207.792206), vec3(13.246755, -0.000000, 0.000000), vec3(2.454545, 2.454545, 2.454545), vec3(13.246754, 0.000000, 0.000000))
    sceneTable.entities[newEntity.name] = newEntity
