function easyCraftRecreate()
    ...
    local newEntity = EasyCraft.makeAThing("46142188", "SpaceKit", "spaceCraft5.obj", vec3(78.422089, -3.829004, -175.647125), vec3(175.471527, 25.273581, -160.593262), vec3(2.874009, 2.874009, 2.874009), vec3(-12.467532, 157.402603, -17.922077))
    sceneTable.entities[newEntity.name] = newEntity
