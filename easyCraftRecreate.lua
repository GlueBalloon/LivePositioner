function easyCraftRecreate()
    ...
    local newEntity = EasyCraft.makeAThing("54461305", "SpaceKit", "pipeStraight.obj", vec3(-80.346321, 16.536797, -244.242416), vec3(-30.303030, -3.030303, 0.000000), vec3(3.090909, 3.090909, 2.441558), vec3(-30.303030, -3.030303, 0.000000))
    sceneTable.entities[newEntity.name] = newEntity
